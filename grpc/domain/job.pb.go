...
type Employer struct {
	...
	EmployerIsLanco  string `protobuf:"bytes,4,opt,name=employer_is_lanco,json=employerIsLanco,proto3" json:"employer_is_lanco,omitempty"`
}
...
func (x *Employer) GetEmployerIsLanco() string {
	if x != nil {
		return x.EmployerIsLanco
	}
	return ""
}
...
type UpdateJobCompanyProfile struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	IsLanco     string    `protobuf:"bytes,4,opt,name=is_lanco,json=isLanco,proto3" json:"is_lanco,omitempty"`
	Jobs        []*JobIds `protobuf:"bytes,5,rep,name=jobs,proto3" json:"jobs,omitempty"`
}

func (x *UpdateJobCompanyProfile) Reset() {
	*x = UpdateJobCompanyProfile{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_domain_job_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *UpdateJobCompanyProfile) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateJobCompanyProfile) ProtoMessage() {}

func (x *UpdateJobCompanyProfile) ProtoReflect() protoreflect.Message {
	mi := &file_protos_domain_job_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateJobCompanyProfile.ProtoReflect.Descriptor instead.
func (*UpdateJobCompanyProfile) Descriptor() ([]byte, []int) {
	return file_protos_domain_job_proto_rawDescGZIP(), []int{4}
}

func (x *UpdateJobCompanyProfile) GetEmployerId() string {
	if x != nil {
		return x.EmployerId
	}
	return ""
...
func (x *UpdateJobCompanyProfile) GetCompanyName() string {
	if x != nil {
...
func (x *UpdateJobCompanyProfile) GetPhoto() string {
	if x != nil {
		return x.Photo
	}
	return ""
...
func (x *UpdateJobCompanyProfile) GetIsLanco() string {
	if x != nil {
		return x.IsLanco
	}
	return ""
...
func (x *UpdateJobCompanyProfile) GetJobs() []*JobIds {
	if x != nil {
		return x.Jobs
	}
	return nil
...
var file_protos_domain_job_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x79, 0x22, 0x1b, 0x0a, 0x09, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4a, 0x6f, 0x62,
	0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64,
	0x22, 0xaa, 0x01, 0x0a, 0x08, 0x45, 0x6d, 0x70, 0x6c, 0x6f, 0x79, 0x65, 0x72, 0x12, 0x1f, 0x0a,
	...
	,
	...
	0x68, 0x6f, 0x74, 0x6f, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x6c, 0x61, 0x6e, 0x63, 0x6f,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x69, 0x73, 0x4c, 0x61, 0x6e, 0x63, 0x6f, 0x12,
	0x29, 0x0a, 0x04, 0x6a, 0x6f, 0x62, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x4a, 0x6f,
	0x62, 0x49, 0x64, 0x73, 0x52, 0x04, 0x6a, 0x6f, 0x62, 0x73, 0x42, 0x33, 0x5a, 0x31, 0x67, 0x69,
	...
	0x69, 0x63, 0x65, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x62,
...
var file_protos_domain_job_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_protos_domain_job_proto_goTypes = []interface{}{
	(*Job)(nil),                     // 0: protos.domain.Job
	(*DeleteJob)(nil),               // 1: protos.domain.DeleteJob
	(*Employer)(nil),                // 2: protos.domain.Employer
	(*JobIds)(nil),                  // 3: protos.domain.JobIds
	(*UpdateJobCompanyProfile)(nil), // 4: protos.domain.UpdateJobCompanyProfile
}
var file_protos_domain_job_proto_depIdxs = []int32{
	2, // 0: protos.domain.Job.employer_company:type_name -> protos.domain.Employer
	3, // 1: protos.domain.UpdateJobCompanyProfile.jobs:type_name -> protos.domain.JobIds
...
func file_protos_domain_job_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protos_domain_job_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateJobCompanyProfile); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
