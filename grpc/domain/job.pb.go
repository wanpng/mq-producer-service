...
type Employer struct {
	...
	EmployerIsLanco  bool   `protobuf:"varint,4,opt,name=employer_is_lanco,json=employerIsLanco,proto3" json:"employer_is_lanco,omitempty"`
}
...
func (x *Employer) GetEmployerIsLanco() bool {
	if x != nil {
...
func (x *UpdateJobCompanyProfile) GetIsLanco() bool {
	if x != nil {
		return x.IsLanco
	}
	return false
...
var file_protos_domain_job_proto_rawDesc = []byte{
	...
	0x5f, 0x6c, 0x61, 0x6e, 0x63, 0x6f, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x65, 0x6d,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x4c, 0x61, 0x6e, 0x63, 0x6f, 0x12,
