...
func (x *Affiliations) GetAffiliationId() string {
	if x != nil {
...
func (x *Affiliations) GetOrganization() string {
	if x != nil {
...
func (x *Affiliations) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
func (x *Affiliations) GetLocation() string {
	if x != nil {
		return x.Location
	}
	return ""
...
func (x *Affiliations) GetDescription() string {
	if x != nil {
...
type JobseekerAffiliation struct {
	...
	Affiliations []*Affiliations `protobuf:"bytes,2,rep,name=affiliations,proto3" json:"affiliations,omitempty"`
}
...
func (x *JobseekerAffiliation) GetAffiliations() []*Affiliations {
	if x != nil {
...
var file_protos_domain_affiliation_proto_rawDesc = []byte{
	...
	0x22, 0xab, 0x01, 0x0a, 0x0c, 0x41, 0x66, 0x66, 0x69, 0x6c, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x73, 0x12, 0x25, 0x0a, 0x0e, 0x61, 0x66, 0x66, 0x69, 0x6c, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x61, 0x66, 0x66, 0x69, 0x6c,
	0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x22, 0x0a, 0x0c, 0x6f, 0x72, 0x67, 0x61,
	...
	0x0a, 0x14, 0x4a, 0x6f, 0x62, 0x73, 0x65, 0x65, 0x6b, 0x65, 0x72, 0x41, 0x66, 0x66, 0x69, 0x6c,
	0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x3f, 0x0a, 0x0c, 0x61, 0x66, 0x66, 0x69, 0x6c, 0x69,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x41, 0x66, 0x66,
	0x69, 0x6c, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x0c, 0x61, 0x66, 0x66, 0x69, 0x6c,
	0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x33, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_protos_domain_affiliation_proto_goTypes = []interface{}{
	(*Affiliations)(nil),         // 0: protos.domain.Affiliations
	(*JobseekerAffiliation)(nil), // 1: protos.domain.JobseekerAffiliation
}
var file_protos_domain_affiliation_proto_depIdxs = []int32{
	0, // 0: protos.domain.JobseekerAffiliation.affiliations:type_name -> protos.domain.Affiliations
